...
import kotlinx.android.synthetic.main.fragment_subscrition.*
...
class SubscriptionFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        viewModel =
            ViewModelProvider(this,
                ViewModelProvider.NewInstanceFactory()).get(SubscriptionViewModel::class.java)

        val root = inflater.inflate (R.layout.fragment_subscrition, container, false)
    ...
    fun initView(){
        viewModel.listMethods.observe(viewLifecycleOwner){
            recyclerSubscriptions.layoutManager = LinearLayoutManager(context)
    ...
    private fun onItemClick(method: Methods) {
        ...
        findNavController().navigate(R.id.action_nav_subscription_to_subscriptionFormFragment, bundle)
    }
